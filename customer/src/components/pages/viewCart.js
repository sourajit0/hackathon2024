                ...
                {cartItems.length === 0 ? (
                    ...
                    <div>
                        ...
                        <div className="total">
                            ...
                            <p style={{color:"white"}}>Rs {cartItems.reduce((total, item) => total + (item.price * item.quantity), 0)}</p>
                        </div>
                        <button className='Checkout' style={{margin:"20px"}}>Proceed to Checkout</button>
                    </div>
                )}
            </div>
            <Footer />
